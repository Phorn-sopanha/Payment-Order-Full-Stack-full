...
import CategoryWistProductDisplay from '../components/CategoryWiseProductDisplay';
    ...
    <div className='container mx-auto p-4'>
       <div className='min-h-[200px] flex flex-col lg:flex-row gap-4'>
          ...
          <div className='h-96 flex flex-col lg:flex-row-reverse gap-4'>
              ...
              <div className='h-[300px] lg:h-96 lg:w-96 bg-slate-200 relative p-2'>
          ...
          {/* product - Details */}
          {
            loading ? (
              ...
              <div className='flex flex-col gap-1'>
                  <p className='bg-slate-400 text-red-500 px-2 rounded-full inline-block w-fit'>{data.brandName}</p>
                  <h2 className='text-2xl lg:text-4xl font-medium'>{data.productName}</h2>
                  <p className='capitalize text-slate-500'>{data.category}</p>

                  <div className='flex text-red-600 items-center gap-0.5'>
                    <FaStar />
                    <FaStar />
                    <FaStar />
                    <FaStar />
        ...
        {
          data?.category && (
            <CategoryWistProductDisplay category = {data?.category} heading={"Recommended Product"}/>
          )
        }
