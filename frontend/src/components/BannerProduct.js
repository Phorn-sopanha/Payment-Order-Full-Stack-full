...
const BannerProduct = () => {
    ...
    return (
    <div className='container mx-auto px-4 rounded py-7'>
        <div className='h-60 md:h-72 w-full bg-slate-300 relative'>

            <div className='absolute z-10 w-full h-full md:flex items-center hidden'>
                <div className='flex justify-between w-full text-3xl m-3'>
