...
const CategoryWistProductDisplay = ({category , heading}) => {
                        ...
                        return(
                            <Link to={"/product/" + product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow' onClick={scrollTop}>
                                <div className='bg-slate-200 h-48 p-4 min-w-[280px] md:min-w-[145px] flex justify-center items-center'>
                                    <img src={product?.productImage[0]} className='object-scale-down h-full hover:scale-110 transition-all cursor-pointer mix-blend-multiply' alt='dd'/>
                                </div>
                                <div className='p-4 grid'>
                                    ...
                                    <button className='text-sm bg-slate-600 hover:bg-red-600 text-white px-3 rounded-full py-0.5' onClick={(e)=>handleAddToCart(product?._id)}>Add to Cart</button>
                                </div>
                            </Link>
                        )
                    })
...
export default CategoryWistProductDisplay
